...
public class ExtendFaceTest : ExampleBase
{
    
    [Serializable] public class ExtendFaceSetting
    {
        [Range(0,24)] public int startingEdge = 0;
        [Range(1,24)] public int faceSkip = 2;
        [Range(1,24)] public int edgeSkip = 2;
        [FormerlySerializedAs("augmentSides")] [Range(3,24)] public int numberOfSides = 4;
        public bool weld = false;
    }

    [FormerlySerializedAs("AugmentSettings")]
    public List<ExtendFaceSetting> ExtendFaceSettings;
    ...
    public override void Generate()
    {
        ...
        foreach (var setting in ExtendFaceSettings)
        {
            ...
            foreach (var face in facesToAugment)
            {
                ...
                {
                    poly.ExtendFace(face, j, setting.numberOfSides);
                }
            }

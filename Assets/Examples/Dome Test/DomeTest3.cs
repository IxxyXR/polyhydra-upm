...
public class DomeTest3 : MonoBehaviour
{
    ...
    public void Generate()
    {
        ...
        var domes = roofs.LoftAlongProfile(new OpParams(DomeDepth, DomeHeight, FaceSelections.All), Profile, rotateProfile: RotateProfile);
